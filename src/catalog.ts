...
export const REVIEW_MAP: Record<string, string[]> = {
  "mobile-app": [
    ...
    "clean-app-design", "iconography", "brand-on-native-platforms", "interaction-design-classics", "ux-writing", "i18n-localization",
  ...
  website: [
    ...
    "modern-css-design-primitives", "ux-writing", "i18n-localization",
