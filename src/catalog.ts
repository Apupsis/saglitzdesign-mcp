...
export const REVIEW_MAP: Record<string, string[]> = {
  ...
  website: [
    ...
    "ethical-design", "ecommerce-checkout", "web-security-headers",
  ],
  "landing-page": [
...
export const ROADMAPS: Record<string, Roadmap> = {
  website: {
    ...
    phases: [
      ...
      { title: "5. Build, performance & hardening", goal: "CWV budget met; semantic, extractable HTML; security headers set before launch, not after an audit", docs: ["seo-for-designers", "design-engineering", "modern-css-design-primitives", "accessibility", "motion-microinteractions", "web-security-headers"] },
