...
export const REVIEW_MAP: Record<string, string[]> = {
  "mobile-app": [
    ...
    "buttons", "forms-inputs", "navigation", "mobile-navigation-home", "cards-lists-modals",
    ...
    "clean-app-design", "iconography", "interaction-design-classics", "ux-writing", "i18n-localization",
...
export const ROADMAPS: Record<string, Roadmap> = {
  website: {
    ...
    phases: [
      ...
      { title: "4. Wireframe & visual design", goal: "Real copy in layouts; conversion patterns; clean craft pass", docs: ["conversion-ux", "web-hero-sections", "web-feature-sections", "web-pricing-sections", "web-landing-signup", "web-social-proof-footer", "ecommerce-checkout", "clean-app-design", "web-trends-2026", "design-engineering", "i18n-localization", ...CORE_FOUNDATION, ...CORE_CRAFT] },
  ...
  "ios-app": {
    ...
    phases: [
      ...
      { title: "2. IA & flows", goal: "≤5 tab destinations; critical flows mapped; trunk test", docs: ["information-architecture", "navigation", "ios-app-design", "mobile-navigation-home"] },
      { title: "3. Wireframes, copy & edge states", goal: "Real copy; empty/loading/error/offline designed; permission priming planned", docs: ["ux-writing", "mobile-empty-states-buttons", "onboarding-permission-priming", "i18n-localization", "dont-make-me-think"] },
      ...
      { title: "5. Hi-fi design & craft", goal: "All states, all sizes; clean & calm; motion + haptics; reduced motion", docs: ["mobile-ux", "buttons", "forms-inputs", "cards-lists-modals", "clean-app-design", "ai-product-ux", "motion-microinteractions", ...CORE_CRAFT] },
  ...
  "android-app": {
    ...
    phases: [
      ...
      { title: "2. IA & flows", goal: "Nav bar destinations; critical flows; predictive back correct", docs: ["information-architecture", "android-app-design", "navigation", "mobile-navigation-home"] },
      { title: "3. Wireframes, copy & edge states", goal: "Real copy; all edge states; permission priming planned", docs: ["ux-writing", "mobile-empty-states-buttons", "onboarding-permission-priming", "i18n-localization", "dont-make-me-think"] },
      ...
      { title: "5. Hi-fi design & craft", goal: "All states/sizes; clean & calm; 60fps; reduced motion", docs: ["mobile-ux", "buttons", "forms-inputs", "cards-lists-modals", "clean-app-design", "ai-product-ux", "motion-microinteractions", ...CORE_CRAFT] },
