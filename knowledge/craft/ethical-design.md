...
sources: ["https://www.deceptive.design/types", "https://www.ftc.gov/reports/bringing-dark-patterns-light", "https://www.nngroup.com/articles/deceptive-patterns/", "https://www.edpb.europa.eu/our-work-tools/our-documents/guidelines/guidelines-032022-deceptive-design-patterns-social-media_en", "https://cppa.ca.gov/announcements/2024/20240904.html", "https://cppa.ca.gov/regulations/pdf/20230329_final_regs_text.pdf", "https://www.edpb.europa.eu/system/files/2023-01/edpb_20230118_report_cookie_banner_taskforce_en.pdf", "https://eur-lex.europa.eu/eli/reg/2022/2065/oj", "https://www.w3.org/WAI/fundamentals/accessibility-principles/"]
updated: 2026-08-12
---
...
- **The law has caught up.** What used to be a UX-ethics debate is now regulated design. High level, without legal advice:
  ...
  - **California — CPRA/CCPA.** The statute names "dark patterns" explicitly: a UI that subverts consumer choice is not valid consent. The CCPA regulations require **symmetry in choice**: "The path for a consumer to exercise a more privacy-protective option shall not be longer or more difficult or time-consuming than the path to exercise a less privacy-protective option" (§ 7004(a)(2)) — with a banner as the worked example, where "Accept All" next to "More Information" or "Preferences" is *not* symmetrical because accepting takes one step and declining takes more, and "Accept All" next to "Decline All" is. The CPPA's 2024 dark-patterns enforcement advisory restates it. Note the axis: this rule is about **path length, not pixels.** Design implication: **no "Accept all" button without an equally easy "Reject all."**
...
- **Symmetric consent banners.** "Accept all" and "Reject all" as equally prominent buttons on the first layer — same size, weight, and click cost. No pre-ticked boxes, no "Reject" buried two layers deep. Be precise about where that rule comes from: **equal click cost is a legal requirement in California** (§ 7004(a)(2), above), while **equal visual weight is this guide's rule, not a regulator's.** The EDPB's Cookie Banner Taskforce expressly declined to set one — "a general banner standard concerning colour and/or contrast cannot be imposed on data controllers" — and requires a case-by-case check that colours are not "obviously misleading," its own example of manifest failure being a reject button whose text contrast is so low it is unreadable. Ship the stricter version anyway: it is exactly what the **Misdirection** row above forbids, it spares you a case-by-case argument you would have to win one banner at a time, and a ghost-button reject fails contrast on [[accessibility]] grounds regardless of any privacy rule. The regulatory detail belongs to [[privacy-consent-and-tracking]], not here.
