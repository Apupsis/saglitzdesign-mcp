...
sources: ["https://www.deceptive.design/types", "https://www.ftc.gov/reports/bringing-dark-patterns-light", "https://www.nngroup.com/articles/deceptive-patterns/", "https://www.edpb.europa.eu/our-work-tools/our-documents/guidelines/guidelines-032022-deceptive-design-patterns-social-media_en", "https://cppa.ca.gov/announcements/2024/20240904.html", "https://cppa.ca.gov/regulations/pdf/20230329_final_regs_text.pdf", "https://cppa.ca.gov/regulations/pdf/ccpa_updates_cyber_risk_admt_appr_text.pdf", "https://www.edpb.europa.eu/system/files/2023-01/edpb_20230118_report_cookie_banner_taskforce_en.pdf", "https://eur-lex.europa.eu/eli/reg/2022/2065/oj", "https://www.w3.org/WAI/fundamentals/accessibility-principles/"]
updated: 2026-08-13
---
...
- **The law has caught up.** What used to be a UX-ethics debate is now regulated design. High level, without legal advice:
  ...
  - **EU — GDPR / DSA / DMA.** GDPR requires consent to be freely given, specific, informed, and unambiguous (opt-in, not preselected). The EDPB *Guidelines 03/2022 on Deceptive Design Patterns* catalog consent-interface tricks to avoid. **DSA Article 25** flatly prohibits online-platform interfaces that "deceive or manipulate" users or impair free, informed decisions. The DMA bars gatekeepers from nudging users away from privacy-protective defaults. Design implication: **a real reject option must sit on the same layer as accept and be no harder to reach** — the EDPB's Cookie Banner Taskforce found that a banner with a consent button and no refuse option on any layer "is not in line with the requirements for a valid consent and thus constitutes an infringement." It stopped short of mandating equal *visual* weight; [[privacy-consent-and-tracking]] carries that detail.
  - **California — CPRA/CCPA.** The statute names "dark patterns" explicitly: a UI that subverts consumer choice is not valid consent. The CCPA regulations require **symmetry in choice**: "The path for a consumer to exercise a more privacy-protective option shall not be longer or more difficult or time-consuming than the path to exercise a less privacy-protective option" (§ 7004(a)(2)) — with a banner as the worked example, where "Accept All" next to "More Information" or "Preferences" is *not* symmetrical because accepting takes one step and declining takes more, and "Accept All" next to "Decline All" is. The CPPA's 2024 dark-patterns enforcement advisory restates it. Note the axis, because it is wider than click-counting: that chapeau governs path length, but it continues "Illustrative examples and requirements follow," and in the regulations effective 1 January 2026 two of those subparagraphs are about visual prominence. **(D)**: "A choice where the 'yes' button is more prominent (e.g., larger in size or in a more eye-catching color) than the 'no' button is not equal or symmetrical." **(E)** says the same of a financial-incentive choice that is preselected or "featured more prominently (e.g., larger in size or in a more eye-catching color)" than the choice not to participate. Design implication: **no "Accept all" button without an equally easy "Reject all," and no visually louder "Accept all" either.**
...
- **Symmetric consent banners.** "Accept all" and "Reject all" as equally prominent buttons on the first layer — same size, weight, and click cost. No pre-ticked boxes, no "Reject" buried two layers deep. Be precise about where that rule comes from: **equal click cost *and* a no-more-prominent accept button are both legal requirements in California** (§ 7004(a)(2) and its subparagraphs (D)–(E), above), while **pixel-identical buttons are this guide's rule, not a regulator's.** The EDPB's Cookie Banner Taskforce expressly declined to set a general colour or contrast standard — "a general banner standard concerning colour and/or contrast cannot be imposed on data controllers" — and requires a case-by-case check that colours are not "obviously misleading," its own example of manifest failure being a reject button whose text contrast is so low it is unreadable. Ship the stricter version anyway: it is exactly what the **Misdirection** row above forbids, it spares you a case-by-case argument you would have to win one banner at a time, and a ghost-button reject fails contrast on [[accessibility]] grounds regardless of any privacy rule. The rest of the EDPB detail belongs to [[privacy-consent-and-tracking]], not here.
