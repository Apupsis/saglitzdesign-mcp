# SaglitzDesign Skills

Self-contained design skills you can install into any skills-compatible agent
(Claude Code, Cursor, and others) with the [skills](https://skills.sh) CLI:
...
| Skill | Use it for |
|---|---|
| **clean-interface-design** | Designing clean, calm, uncluttered UI with clear hierarchy and restraint. |
| **landing-page-conversion** | Building or fixing landing pages / marketing sites that actually convert. |
